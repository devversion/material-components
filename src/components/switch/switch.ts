...
@Component({
  ...
  templateUrl: 'dist/src/components/switch/switch.html',
  styleUrls: [
    'dist/src/components/switch/switch.css'
  ],
  providers: [MdDrag],
...
export class MdSwitch implements ControlValueAccessor {
  ...
  ngOnInit() {
    ...
    this.mdDrag.register(this.switchContainer);
  ...
  set checked(value) {
    ...
    this.componentElement.setAttribute('aria-checked', this.checked_);
